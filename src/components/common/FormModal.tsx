...
const doctorFormSchema = z.object({
  ...
  // Practitioner Info
  identifier_system: z.string().url("Must be a valid URL"),
  identifier_value: z.string().min(1, "Identifier value is required"),
  prefix: z.string().optional(),
  given_name: z.string().min(1, "Given name is required"),
  family_name: z.string().min(1, "Family name is required"),
  telecom_phone: z.string().min(10, "Phone number is required"),
  telecom_email: z.string().email("Work email is required"),
  ...
  // Role Info
  role_code_system: z.string().url("Must be a valid URL"),
  role_code: z.string().min(1, "Role code is required"),
  role_display: z.string().min(1, "Role display is required"),
  role_text: z.string().min(1, "Role text is required"),
  specialty: z.string().min(1, "Specialty is required"),
  location_reference: z.string().min(1, "Location reference is required"),
  location_display: z.string().min(1, "Location display is required"),
  healthcare_service_reference: z.string().min(1, "Healthcare service reference is required"),
  healthcare_service_display: z.string().min(1, "Healthcare service display is required"),
  period_start: z.string().min(1, "Period start is required"),
  period_end: z.string().min(1, "Period end is required"),
  
  // Availability
  availability_days: z.array(z.string()).min(1, "Select at least one day"),
  available_times: z.array(z.object({
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Practitioner Information</h3>
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  control={form.control}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://medicalcouncil.org/license" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="work@example.com" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://your-cdn.com/images/profile.jpg" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://your-cdn.com/licenses/license.pdf" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="NextCare Health Center, Bengaluru" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => appendTime({ start: "09:00", end: "17:00" })}
                >
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Not Available (Optional)</h3>
