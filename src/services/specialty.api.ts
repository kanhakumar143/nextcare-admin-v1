...
export const updateSpecialtyStatus = async (
  specialty: Specialty,
  id: string
) => {
  try {
...
export const getSpecialtyByTenantId = async (tenantId: string | null) => {
  try {
    const response = await api.get(`specialty-by-tenant`, {
